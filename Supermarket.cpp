...
{
    fstream FoodFile;
    FoodFile.open("Food.txt", ios::out);
    if (FoodFile.is_open())
    {
...
void Supermarket::saveToDetergentFile()
{
    ...
    DetergentFile.open("Detergent.txt", ios::out);
...
{
    fstream CannedFile;
    CannedFile.open("Canned.txt", ios::out);
...
void Supermarket::loadFromFood()
{
    ...
    if (FoodFile.is_open())
    {
        ...
        while (getline(FoodFile, line))
        {
            ...
            parse >> food_id[food_count]
                >> food_name[food_count]
                >> food_price[food_count]
                >> food_quantity[food_count];
...
{
    fstream DetergentFile;
    DetergentFile.open("Detergent.txt", ios::in);
    if (DetergentFile.is_open())
    {
        string line;
        detergent_count = 0;
        ...
        {
            stringstream parse(line);
            parse >> detergent_id[detergent_count]
                >> detergent_name[detergent_count]
                >> detergent_price[detergent_count]
                >> detergent_quantity[detergent_count];
...
{
    fstream CannedFile;
    CannedFile.open("Canned.txt", ios::in);
    if (CannedFile.is_open())
    {
        string line;
        canned_count = 0;
        ...
        {
            stringstream parse(line);
            parse >> canned_id[canned_count]
                >> canned_name[canned_count]
                >> canned_price[canned_count]
                >> canned_quantity[canned_count];
...
{
    fstream FoodFile("Food.txt", ios::out);
    if (FoodFile.is_open())
    {
...
{
    fstream DetergentFile("Detergent.txt", ios::out);
    if (DetergentFile.is_open())
    {
...
{
    fstream CannedFile("Canned.txt", ios::out);
    if (CannedFile.is_open())
    {
